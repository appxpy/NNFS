...
FUNCTION(SETUP_TARGET_FOR_COVERAGE _targetname _testrunner _outputname)
	...
	ADD_CUSTOM_TARGET(${_targetname}
		...
		COMMAND ${LCOV_PATH} --remove ${_outputname}.info '${CMAKE_SOURCE_DIR}/build/*' '${CMAKE_SOURCE_DIR}/external/*' '/Library/*' '/usr/*' '/opt/homebrew/*' --output-file ${_outputname}.info.cleaned
