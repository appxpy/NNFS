...
#define clue_LOG_EXPRESSION(severity, expr)                                                                                                                                                        \
    ...
    {                                                                                                                                                                                              \
        ...
        {                                                                                                                                                                                          \
            if (clue_is_active(severity))                                                                                                                                                          \
            {                                                                                                                                                                                      \
                clue::filelog() << clue::now_text() << std::setw(clue_LOG_PREFIX_WIDTH) << clue::to_severity_text(severity) << clue::to_module_text(clue_LOG_MODULE_NAME) << ": " << expr << "\n"; \
            }                                                                                                                                                                                      \
        }                                                                                                                                                                                          \
    } while (clue::is_true(false))
#endif
...
#define clue_LOG_EXPRESSION(severity, expr)                                                                                                                           \
    ...
    {                                                                                                                                                                 \
        ...
        {                                                                                                                                                             \
            if (clue_is_active(severity))                                                                                                                             \
            {                                                                                                                                                         \
                clue::windbg() << std::setw(clue_LOG_PREFIX_WIDTH) << clue::to_severity_text(severity) << clue::to_module_text(clue_LOG_MODULE_NAME) << ": " << expr; \
            }                                                                                                                                                         \
        }                                                                                                                                                             \
    } while (clue::is_true(false))
#endif
...
#define clue_LOG_EXPRESSION(severity, expr)                                                                                     \
    ...
    {                                                                                                                           \
        ...
        {                                                                                                                       \
            if (clue_is_active(severity))                                                                                       \
            {                                                                                                                   \
                clue::evtlog(severity, clue_LOG_MODULE_NAME) << clue::text_with_or("", clue_LOG_MODULE_NAME, ": ", "") << expr; \
            }                                                                                                                   \
        }                                                                                                                       \
    } while (clue::is_true(false))
#endif
...
#define clue_LOG_EXPRESSION(severity, expr)                                     \
    ...
    {                                                                           \
        ...
        {                                                                       \
            if (clue_is_active(severity))                                       \
            {                                                                   \
                clue::syslog(severity) << clue_LOG_MODULE_NAME << ": " << expr; \
            }                                                                   \
        }                                                                       \
    } while (clue::is_true(false))
#endif
...
namespace clue
{
    ...
    public:
        strlog()
            : severity_(clue_LOG_SEV_NONE), stream() {}
...
namespace clue
{
    ...
    inline int to_eventlog_severity(int severity)
    {
        ...
        switch (severity)
        {
        case clue_LOG_SEV_NONE:
            return EVENTLOG_INFORMATION_TYPE;
        case clue_LOG_SEV_EMERGENCY:
            return EVENTLOG_ERROR_TYPE;
        case clue_LOG_SEV_ALERT:
            return EVENTLOG_ERROR_TYPE;
        case clue_LOG_SEV_CRITICAL:
            return EVENTLOG_ERROR_TYPE;
        case clue_LOG_SEV_ERROR:
            return EVENTLOG_ERROR_TYPE;
        case clue_LOG_SEV_WARNING:
            return EVENTLOG_WARNING_TYPE;
        case clue_LOG_SEV_NOTICE:
            return EVENTLOG_INFORMATION_TYPE;
        case clue_LOG_SEV_INFO:
            return EVENTLOG_INFORMATION_TYPE;
        default:
    ...
    public:
        evtlog(int const severity, std::string const &module)
            : severity(severity), module(module), stream() {}
